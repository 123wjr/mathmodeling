...
| 根目录未跟踪同名文件 SHA-256 | `e3d40561da14c988531413c9d2069ec4a3ae97e4d19eeebedc6a12ce01d42dc2`；不是最新骨架 |
| 仓库旧模板 SHA-256 | `6812912987ecad46a4a452ad55a32cce2332221bf4b038d1a3ecb8ab18bcfdfe`；不得覆盖最新骨架 |
| 技术过渡文档 | `technical/PAPER_TECHNICAL_BRIDGE.md` |
| 技术过渡文档 SHA-256 | `61ecf33e939ba0e17180b2c268b6999ddc027c6813c1451659f7a4c0c6ea7787` |
...
- DOCX 章节映射、图表接口、主张-证据矩阵、附录索引和更新注册表。
...
1. 最新 DOCX 到在线文档的逐段替换及图号固定：`PENDING_PAPER_AGENT`。
...
1. 以下载版 DOCX 为骨架，按 A5 技术块填充在线文档。
2. 每个结果句回填主张-证据表；未核验文献保留 `EVIDENCE_REQUIRED`。
3. 删除模板示例、无关参考文献和示例代码。
